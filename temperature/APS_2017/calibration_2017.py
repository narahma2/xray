...
from temperature_processing import main as temperature_processing, pca
...
def main(test, scan):
	...
	# # Sort temperature
	# temperature_avg = np.array(temperature_avg)
	# sort_ind = np.argsort(temperature_avg)
	# temperature_avg = temperature_avg[sort_ind]

	# # Sort intensity based on temperature
	# intensity_avg = np.array(intensity_avg)
	# intensity_avg = intensity_avg[sort_ind]
	...
	rr = np.array([(x-min(temperature_avg))/(max(temperature_avg)-min(temperature_avg)) for x in temperature_avg])
	bb = np.array([1-(x-min(temperature_avg))/(max(temperature_avg)-min(temperature_avg)) for x in temperature_avg])
