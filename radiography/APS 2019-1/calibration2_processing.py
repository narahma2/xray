# -*- coding: utf-8 -*-
"""
Created on Fri Jun  7 16:24:20 2019
...
cal_ind = [a for a, b in enumerate(["Calibration2" in c for c in test_matrix["Test"]]) if b]
#cal_ind = cal_ind[14:]
cal_ind = [cal_ind[0]] + [cal_ind[4]] + [cal_ind[11]] + [cal_ind[12]] + [cal_ind[18]] + [cal_ind[19]]
#cal_ind = [a for a, b in enumerate(["Partitions14" in c for c in test_matrix["Test"]]) if b]
...
#            break
    ...
    f = open("R:/APS 2019-1/Imaging/Processed_WB_Images/Water/Calibration2/" + test_matrix["Test"][index] + ".pckl", "wb")
